...
def parse_args(*args):
    ...
    parser.add_argument('-MINC2500','--MINC2500', default=True) # opt.MINC2500
    parser.add_argument('-data_path','--data_path', default='data/minc-2500/')  # opt.data_path
    parser.add_argument('-train_txt_path','--train_txt_path', default='data/mincTrainImages.txt') # opt.train_txt_path
    parser.add_argument('-test_txt_path','--test_txt_path', default='data/mincTestImages.txt') # opt.test_txt_path
    ...
    parser.add_argument('-save_low_bound','--save_low_bound', type=float, default=99) # opt.save_low_bound)
    ...
    parser.add_argument('-pre_model_path','--pre_path', default='data/vgg16-397923af.pth') # opt.pre_path
